...
This QA project demonstrates testing of the [Restful-Booker API](https://restful-booker.herokuapp.com/), showcasing STLC process and API test automation skills - from test planning to test reporting.
